...
class TestEnemyElite(BaseEnemy):
    def __init__(self, Name, WeakList):
        super().__init__()
        self.Name = Name
        self.MaxToughness = 300
    ...
    def Skill_2(self, target):
        ...
        for Character in self.Game.Characters.copy():
            self.Game.ApplyDamage(Attacker = self, Target = Character, Element = '허수', DamageType = '필살기', Toughness = 0, Multiplier = [0.0, 2.0, 0.0], FlatDMG = 0, DamageName = f'{self.Name} 전체공격')
